...
// Description : To test all the implemented functions
//============================================================================
...
bool test_normalize() {
	...
	if (correct) {
		...
		show_grid_float(unnormalized);
		cout << "\nYour code returned the following:\n\n";
		show_grid_float(result);
		cout << "\nWhen it should have returned the following:\n";
		show_grid_float(normalized);
	}
	return correct;
}
...
bool test_initialize() {
	...
	if (h < 1) {
		cout
				<< "failed to load map. Make sure there is a maps/ directory in the same directory as this file!\n";
		return false;
	}
...
bool test_move() {
	...
	if (right) {
		...
		cout
				<< "When dx=1, dy=1, blurring=0.0 and with\nthe following beliefs:\n\n";
		show_grid_float(in);
		cout << "\nYour code returned the following:\n\n";
		show_grid_float(out);
		cout << "\nWhen it should have returned the following:\n";
...
bool test_sense() {
	...
	if (close_enough(r_prob, r_exp) && close_enough(g_prob, g_exp)) {
		...
		cout
				<< "When p_hit=2.0, p_miss=1.0 and with\nthe following beliefs:\n\n";
		show_grid_float(in);
		cout << "\nYour code returned the following:\n\n";
		show_grid_float(out);
